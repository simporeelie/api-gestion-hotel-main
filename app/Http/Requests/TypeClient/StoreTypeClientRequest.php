...
class StoreTypeClientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nbReservation' => 'required|integer|min:1',
            'operateur' => 'required|in:>=,<=,<,>,=',
            'frequense' => 'required|integer|min:1',
    ...
    public function messages(): array
    {
        return [
            ...
            'nbReservation.min' => 'Le champ nombre de réservations doit être au moins 0.',
